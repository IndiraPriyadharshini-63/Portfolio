...
function Navbar() {
  ...
  return (
    <div className="fixed w-full h-[80px]  font-bold flex justify-between items-center px-4 bg-[#ffffff] text-[#b70048]">
      <div>
        <img src={MY_LOGO} alt="logo" width="20" height="20"></img>
      </div>
